...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
    ...
    else if(uartHandle->Instance==USART1)
    {
        ...
        PB7     ------> USART1_RX
        */
        GPIO_InitStruct.Pin = Card_TX_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
        HAL_GPIO_Init(Card_TX_GPIO_Port, &GPIO_InitStruct);

        GPIO_InitStruct.Pin = Card_RX_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        HAL_GPIO_Init(Card_RX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
    ...
    else if(uartHandle->Instance==UART5)
    {
        ...
        PD2     ------> UART5_RX
        */
        HAL_GPIO_DeInit(MPU_TX_GPIO_Port, MPU_TX_Pin);

        HAL_GPIO_DeInit(MPU_RX_GPIO_Port, MPU_RX_Pin);
    ...
    else if(uartHandle->Instance==USART1)
    {
        ...
        PB7     ------> USART1_RX
        */
        HAL_GPIO_DeInit(GPIOB, Card_TX_Pin|Card_RX_Pin);
